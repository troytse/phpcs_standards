 ...
 * - Automatically limit the testing to the HolyhiCS tests.
 *
...
foreach ( $allStandards as $standard ) {
	if ( isset( $hicsStandards[ $standard ] ) === true ) {
		continue;
	}
...
// phpcs:ignore Holyhi.PHP.DiscouragedPHPFunctions.runtime_configuration_putenv -- This is not production, but test code.
